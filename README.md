...
- `with-chromedriver`, `83-with-chromedriver`, `83-with-chromedriver-12` [(Dockerfile)](https://github.com/Zenika/alpine-chrome/blob/master/with-chromedriver/Dockerfile)
